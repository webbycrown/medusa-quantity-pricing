...
import { Plus, PencilSquare, Trash, CurrencyDollar } from "@medusajs/icons";
import { Label, Text, Input, Select, Button, usePrompt, Table, IconButton, Drawer, toast, Container, Heading } from "@medusajs/ui";
...
function PricingAmountGrid({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
    /* @__PURE__ */ jsx(Label, { children: "Pricing" }),
    /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-ui-border-base overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 border-b border-ui-border-base bg-ui-bg-subtle", children: [
        /* @__PURE__ */ jsx(
          Text,
          {
            size: "xsmall",
        ...
        /* @__PURE__ */ jsx(Text, { size: "xsmall", weight: "plus", className: "px-2 py-2 text-center", children: "List price" })
      ] }),
    ...
    /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-muted", children: pricingType === "percentage" ? `Tier unit price = list price − discount %. Currency: ${currencyLabel}` : pricingType === "fixed_discount" ? `Tier unit price = list price − discount amount. Currency: ${currencyLabel}` : "Tier unit price is what the customer pays. List price comes from Medusa variant pricing." }),
    !catalogLoading && catalogPrice == null && pricingType !== "fixed" && /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-error", children: noVariants ? "Enter List price (reference) above, or switch to Fixed price." : "Set variant prices in Medusa or enter List price (reference) above." })
  ] });
}
...
function QuantityPricingForm({
  ...
  const [variantSelectValue, setVariantSelectValue] = useState(
  ...
  const [referenceListPrice, setReferenceListPrice] = useState(
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-y-4", children: [
    !variantSelectLoading && !hasVariants && fixedProductId && /* @__PURE__ */ jsx("div", { className: "rounded-lg border border-ui-border-base bg-ui-bg-subtle px-3 py-2", children: /* @__PURE__ */ jsxs(Text, { size: "small", className: "text-ui-fg-subtle", children: [
      "This product has ",
      /* @__PURE__ */ jsx("strong", { children: "no variants" }),
      ". Use",
      " ",
      /* @__PURE__ */ jsx("strong", { children: "Fixed price" }),
      " tiers for simple volume pricing, or enter a ",
      /* @__PURE__ */ jsx("strong", { children: "List price (reference)" }),
      " below for discount tiers. For checkout, add at least one variant in Medusa when you are ready to sell."
    ] }) }),
    !fixedProductId && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
      /* @__PURE__ */ jsx(Label, { htmlFor: "qp-product-id", children: "Product ID" }),
      /* @__PURE__ */ jsx(
        Input,
        {
          id: "qp-product-id",
    ...
    showVariantField && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
      /* @__PURE__ */ jsx(Label, { htmlFor: "qp-variant-id", children: "Variant (optional)" }),
      /* @__PURE__ */ jsxs(
        Select,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(Select.Trigger, { id: "qp-variant-id", children: /* @__PURE__ */ jsx(Select.Value, { placeholder: "Select variant" }) }),
            /* @__PURE__ */ jsxs(Select.Content, { children: [
              /* @__PURE__ */ jsx(Select.Item, { value: VARIANT_ALL, children: "All variants" }),
              variantOptions.map((v) => /* @__PURE__ */ jsx(Select.Item, { value: v.id, children: v.title || v.sku || v.id }, v.id))
            ] })
          ]
        }
      )
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "qp-currency", children: "Currency" }),
        /* @__PURE__ */ jsx(
          Input,
          {
            id: "qp-currency",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "qp-pricing-type", children: "Pricing type" }),
        /* @__PURE__ */ jsxs(
          Select,
          {
            value: pricingType,
            ...
            children: [
              /* @__PURE__ */ jsx(Select.Trigger, { id: "qp-pricing-type", children: /* @__PURE__ */ jsx(Select.Value, { placeholder: "Select type" }) }),
              /* @__PURE__ */ jsx(Select.Content, { children: PRICING_TYPE_OPTIONS.map((opt) => /* @__PURE__ */ jsx(Select.Item, { value: opt.value, children: opt.label }, opt.value)) })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "qp-min-qty", children: "Min qty" }),
        /* @__PURE__ */ jsx(
          Input,
          {
            id: "qp-min-qty",
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
        /* @__PURE__ */ jsx(Label, { htmlFor: "qp-max-qty", children: "Max qty (empty = 51+)" }),
        /* @__PURE__ */ jsx(
          Input,
          {
            id: "qp-max-qty",
    ...
    showReferenceField && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
      /* @__PURE__ */ jsxs(Label, { htmlFor: "qp-reference-price", children: [
      ...
      /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-muted", children: "Used to calculate discount tiers when Medusa has no variant list price for this currency." })
    ] }),
    resolvedProductId ? /* @__PURE__ */ jsx(
      PricingAmountGrid,
      {
        pricingType,
        discountValue: price,
    ...
    ) : /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: "Enter a product ID to load catalog price." }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-2", children: [
      ...
      /* @__PURE__ */ jsx(Button, { type: "submit", isLoading, children: isEditing ? "Save changes" : "Add rule" })
    ] })
  ] });
}
...
function QuantityPricingRulesManager({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end px-6 py-4 border-b border-ui-border-base", children: /* @__PURE__ */ jsxs(Button, { size: "small", variant: "secondary", onClick: openCreate, children: [
      /* @__PURE__ */ jsx(Plus, {}),
      addButtonLabel
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "px-6 py-4", children: [
      productId && variantsLoaded && !isFetchingVariants && !hasProductVariants && /* @__PURE__ */ jsx("div", { className: "mb-4 rounded-lg border border-ui-border-base bg-ui-bg-subtle px-3 py-2" }),
      isLoading ? /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: "Loading rules..." }) : rules.length === 0 ? /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: productId ? "No quantity tiers for this product yet." : "No quantity pricing rules yet. Add a rule to get started." }) : /* @__PURE__ */ jsxs(Table, { children: [
        /* @__PURE__ */ jsx(Table.Header, { children: /* @__PURE__ */ jsxs(Table.Row, { children: [
          showProductColumn ? /* @__PURE__ */ jsx(Table.HeaderCell, { children: "Product" }) : showVariantColumn ? /* @__PURE__ */ jsx(Table.HeaderCell, { children: "Variant" }) : null,
          /* @__PURE__ */ jsx(Table.HeaderCell, { children: "Qty range" }),
          /* @__PURE__ */ jsx(Table.HeaderCell, { children: "Type" }),
          /* @__PURE__ */ jsx(Table.HeaderCell, { children: "Discount" }),
          /* @__PURE__ */ jsx(Table.HeaderCell, { children: "List price" }),
          /* @__PURE__ */ jsx(Table.HeaderCell, { children: "Tier unit price" }),
          /* @__PURE__ */ jsx(Table.HeaderCell, { children: "Currency" }),
          /* @__PURE__ */ jsx(Table.HeaderCell, { className: "text-right", children: "Actions" })
        ] }) }),
        /* @__PURE__ */ jsx(Table.Body, { children: rules.map((rule) => {
          const base = getBaseUnitPriceForRule(
            catalogByProduct == null ? void 0 : catalogByProduct[rule.product_id],
            rule
          );
          return /* @__PURE__ */ jsxs(Table.Row, { children: [
            showProductColumn ? /* @__PURE__ */ jsxs(Table.Cell, { children: [
              /* @__PURE__ */ jsx(Text, { size: "small", className: "font-mono text-xs", children: rule.product_id }),
              rule.variant_id && /* @__PURE__ */ jsx(Text, { size: "xsmall", className: "text-ui-fg-subtle", children: variantLabel(rule.variant_id, resolvedVariants) })
            ] }) : showVariantColumn ? /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-base", children: variantLabel(rule.variant_id, resolvedVariants) }) }) : null,
            /* @__PURE__ */ jsx(Table.Cell, { children: formatQtyRange(rule) }),
            /* @__PURE__ */ jsx(Table.Cell, { children: /* @__PURE__ */ jsx(Text, { size: "small", children: pricingTypeLabel(rule.pricing_type) }) }),
            /* @__PURE__ */ jsx(Table.Cell, { children: rule.pricing_type === "fixed" ? "—" : formatDiscountCell(rule) }),
            /* @__PURE__ */ jsx(Table.Cell, { children: isLoadingCatalog ? /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: "…" }) : formatCatalogCell(base) }),
            /* @__PURE__ */ jsx(Table.Cell, { children: isLoadingCatalog && rule.pricing_type !== "fixed" ? /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle", children: "…" }) : formatRulePriceDisplay(rule, base) }),
            /* @__PURE__ */ jsx(Table.Cell, { children: rule.currency_code.toUpperCase() }),
            /* @__PURE__ */ jsx(Table.Cell, { className: "text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-1", children: [
              /* @__PURE__ */ jsx(
                IconButton,
                {
                  size: "small",
    ...
    /* @__PURE__ */ jsx(Drawer, { open: drawerOpen, onOpenChange: handleDrawerOpenChange, children: /* @__PURE__ */ jsxs(Drawer.Content, { children: [
      /* @__PURE__ */ jsx(Drawer.Header, { children: /* @__PURE__ */ jsx(Drawer.Title, { children: editingRule ? "Edit quantity pricing rule" : "Add quantity pricing rule" }) }),
      /* @__PURE__ */ jsx(Drawer.Body, { className: "p-4", children: /* @__PURE__ */ jsx(
        QuantityPricingForm,
        {
          productId,
...
const ProductQuantityPricingWidget = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxs(Container, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2 px-6 py-4", children: [
      /* @__PURE__ */ jsx(CurrencyDollar, { className: "text-ui-fg-subtle" }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Heading, { level: "h2", children: "Quantity pricing" }),
        /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle mt-0.5", children: "Volume tiers for this product (e.g. 1–10, 11–50, 51+)." })
      ] })
    ] }),
    /* @__PURE__ */ jsx(
...
const StoreQuantityPricingWidget = () => {
  ...
  return /* @__PURE__ */ jsx(Container, { className: "p-6", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-y-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-2", children: [
        /* @__PURE__ */ jsx(CurrencyDollar, { className: "text-ui-fg-subtle" }),
        /* @__PURE__ */ jsx(Heading, { level: "h2", children: "Quantity pricing engine" })
      ] }),
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle max-w-lg", children: isLoading ? "Loading pricing rules…" : count === 0 ? "No volume tiers configured yet. Rules apply per product (qty 1–10, 11–50, 51+, etc.)." : `${count} active rule${count === 1 ? "" : "s"} across your catalog.` })
    ] }),
    /* @__PURE__ */ jsx(Button, { size: "small", variant: "secondary", asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/settings/quantity-pricing", children: "Manage pricing" }) })
  ] }) });
};
defineWidgetConfig({
...
const QuantityPricingSettingsPage = () => {
  return /* @__PURE__ */ jsxs(Container, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsxs("div", { className: "px-6 py-4", children: [
      /* @__PURE__ */ jsx(Heading, { level: "h1", children: "Quantity pricing" }),
      /* @__PURE__ */ jsx(Text, { size: "small", className: "text-ui-fg-subtle mt-1", children: "Volume tiers per product (e.g. 1–10 → ₹100, 11–50 → ₹90, 51+ → ₹80)." })
    ] }),
    /* @__PURE__ */ jsx(QuantityPricingRulesManager, { showProductColumn: true })
  ] });
};
